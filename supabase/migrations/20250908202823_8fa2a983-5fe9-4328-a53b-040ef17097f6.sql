...
-- Simple SELECT policy - users can view their own itineraries and collaborated ones
...
-- Simple UPDATE policy - users can update their own itineraries and those they can edit
